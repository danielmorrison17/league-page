...
<div id="home">
    <div id="main">
        <div class="text">
            <h6>{leagueName}</h6>
            <p>Since 2011, this league has advanced in many different ways to where it is now.  Going from a re-draft league, to an auction league, and to its current Salary Cap Dynasty League.</p>
        </div>
        <PowerRankings />
    </div>
